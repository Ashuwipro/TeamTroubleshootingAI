(function(global) {
    ...
    function buildFallbackFilename(context) {
        ...
        return clientCompany + '_' + bankName + '_CHECKS_' + date + '_' + time + '.xml';
    }

    async function previewChecksXmlFile(context) {
        var data = context && context.data ? context.data : {};
        var fileType = context && context.fileType ? context.fileType : 'CHECKS XML';
        ...
        var getGeneratePreviewTitle = context && context.getGeneratePreviewTitle ? context.getGeneratePreviewTitle : function() { return 'CHECKS XML Preview'; };
    ...
    async function generateChecksXmlFile(context) {
        var data = context && context.data ? context.data : {};
        var addMessage = context && context.addMessage ? context.addMessage : function() {};
    ...
    global.PcmChecksXmlActions = {
        previewChecksXmlFile: previewChecksXmlFile,
        generateChecksXmlFile: generateChecksXmlFile
    };
})(window);
