(function(global) {
    ...
    async function previewWireIntlXml(context) {
        ...
        var getGeneratePreviewTitle = context && context.getGeneratePreviewTitle ? context.getGeneratePreviewTitle : function() { return 'WebSeries Wire INTL XML Preview'; };
        var fileType = context && context.fileType ? context.fileType : 'WebSeries Wire INTL XML';
    ...
    async function generateWireIntlXml(context) {
        var data = context && context.data ? context.data : {};
    ...
    global.WebSeriesWireIntlXmlActions = {
        previewWireIntlXml: previewWireIntlXml,
        generateWireIntlXml: generateWireIntlXml
    };
})(window);
