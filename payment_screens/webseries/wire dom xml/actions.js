(function(global) {
    ...
    async function previewWireDomXml(context) {
        ...
        var getGeneratePreviewTitle = context && context.getGeneratePreviewTitle ? context.getGeneratePreviewTitle : function() { return 'WebSeries Wire DOM XML Preview'; };
        var fileType = context && context.fileType ? context.fileType : 'WebSeries Wire DOM XML';
    ...
    async function generateWireDomXml(context) {
        var data = context && context.data ? context.data : {};
    ...
    global.WebSeriesWireDomXmlActions = {
        previewWireDomXml: previewWireDomXml,
        generateWireDomXml: generateWireDomXml
    };
})(window);
